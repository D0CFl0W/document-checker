...
(function () {
  ...
  downloadBtn.addEventListener("click", async () => {
    try {
      ...
      a.download =
        "Report_Normokontrol_${new Date().toISOString().slice(0,10)}.docx";
      ...
      alert(
        "Не удалось скачать отчёт. Убедитесь, что проверка на сервере завершена.",
      );
    }
  });
...
>>>>>>> 9a9383f32f10f6cd4a50b43bc191c3a3ad8a79c4
